...
class MFTP {
    ...
    public function getInstance($host = '127.0.0.1', $port = '21', $options = null, $user = null, $pass = null) {
        ...
        if (!isset(self::$instances[$signature]) || !is_object(self::$instances[$signature])) {
            self::$instances[$signature] = new MFTP($options);
        }
        else {
    ...
    public function connect($host = '127.0.0.1', $port = 21) {
        ...
        if (FTP_NATIVE) {
            ...
            if ($this->_conn === false) {
                MError::raiseWarning('30', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_NO_CONNECT', $host, $port));
                return false;
            }
        ...
        if (!$this->_conn) {
            MError::raiseWarning('30', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_NO_CONNECT_SOCKET', $host, $port, $errno, $err));
            return false;
        }
        ...
        if (!$this->_verifyResponse(220)) {
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_BAD_RESPONSE', $this->_response));
            return false;
        }
    ...
    public function login($user = 'anonymous', $pass = 'jftp@joomla.org') {
        ...
        if (FTP_NATIVE) {
            if (@ftp_login($this->_conn, $user, $pass) === false) {
                MError::raiseWarning('30', 'MFTP::login: Unable to login');
                return false;
            }
            return true;
        }
        ...
        if (!$this->_putCmd('USER ' . $user, array(331, 503))) {
            MError::raiseWarning('33', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_BAD_USERNAME', $this->_response, $user));
            return false;
        }
        ...
        if (!$this->_putCmd('PASS ' . $pass, 230)) {
            MError::raiseWarning('34', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_BAD_PASSWORD', $this->_response, str_repeat('*', strlen($pass))));
            return false;
        }
    ...
    public function pwd() {
        ...
        if (FTP_NATIVE) {
            if (($ret = @ftp_pwd($this->_conn)) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_PWD_BAD_RESPONSE_NATIVE'));
                return false;
            }
            return $ret;
        }
        ...
        if (!$this->_putCmd('PWD', 257)) {
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_PWD_BAD_RESPONSE', $this->_response));
            return false;
        }
    ...
    public function syst() {
        ...
        if (FTP_NATIVE) {
            if (($ret = @ftp_systype($this->_conn)) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_SYS_BAD_RESPONSE_NATIVE'));
                return false;
            }
        }
        else {
            ...
            if (!$this->_putCmd('SYST', 215)) {
                MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_SYST_BAD_RESPONSE', $this->_response));
                return false;
            }
            $ret = $this->_response;
        }
    ...
    public function chdir($path) {
        ...
        if (FTP_NATIVE) {
            if (@ftp_chdir($this->_conn, $path) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_CHDIR_BAD_RESPONSE_NATIVE'));
                return false;
            }
            return true;
        }
        ...
        if (!$this->_putCmd('CWD ' . $path, 250)) {
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_CHDIR_BAD_RESPONSE', $this->_response, $path));
            return false;
        }
    ...
    public function reinit() {
        ...
        if (FTP_NATIVE) {
            if (@ftp_site($this->_conn, 'REIN') === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_REINIT_BAD_RESPONSE_NATIVE'));
                return false;
            }
            return true;
        }
        ...
        if (!$this->_putCmd('REIN', 220)) {
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_REINIT_BAD_RESPONSE', $this->_response));
            return false;
        }
    ...
    public function rename($from, $to) {
        ...
        if (FTP_NATIVE) {
            if (@ftp_rename($this->_conn, $from, $to) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_RENAME_BAD_RESPONSE_NATIVE'));
                return false;
            }
            return true;
        }
        ...
        if (!$this->_putCmd('RNFR ' . $from, 350)) {
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_RENAME_BAD_RESPONSE_FROM', $this->_response, $from));
            return false;
        }

        // Send rename to command to the server
        if (!$this->_putCmd('RNTO ' . $to, 250)) {
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_RENAME_BAD_RESPONSE_TO', $this->_response, $to));
            return false;
        }
    ...
    public function chmod($path, $mode) {
        ...
        if (FTP_NATIVE) {
            if (@ftp_site($this->_conn, 'CHMOD ' . $mode . ' ' . $path) === false) {
                if ($this->_OS != 'WIN') {
                    MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_CHMOD_BAD_RESPONSE_NATIVE'));
                }
                return false;
            }
            return true;
        ...
        if (!$this->_putCmd('SITE CHMOD ' . $mode . ' ' . $path, array(200, 250))) {
            if ($this->_OS != 'WIN') {
                MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_CHMOD_BAD_RESPONSE', $this->_response, $path, $mode));
            }
            return false;
        }
        return true;
    ...
    public function delete($path) {
        ...
        if (FTP_NATIVE) {
            if (@ftp_delete($this->_conn, $path) === false) {
                if (@ftp_rmdir($this->_conn, $path) === false) {
                    MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_DELETE_BAD_RESPONSE_NATIVE'));
                    return false;
                }
            }
            return true;
        ...
        if (!$this->_putCmd('DELE ' . $path, 250)) {
            if (!$this->_putCmd('RMD ' . $path, 250)) {
                MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_DELETE_BAD_RESPONSE', $this->_response, $path));
                return false;
            }
        }
        return true;
    ...
    public function mkdir($path) {
        ...
        if (FTP_NATIVE) {
            if (@ftp_mkdir($this->_conn, $path) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_MKDIR_BAD_RESPONSE_NATIVE'));
                return false;
            }
            return true;
        }
        ...
        if (!$this->_putCmd('MKD ' . $path, 257)) {
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_MKDIR_BAD_RESPONSE', $this->_response, $path));
            return false;
        }
        return true;
    }
    ...
    public function restart($point) {
        ...
        if (FTP_NATIVE) {
            if (@ftp_site($this->_conn, 'REST ' . $point) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_RESTART_BAD_RESPONSE_NATIVE'));
                return false;
            }
            return true;
        }
        ...
        if (!$this->_putCmd('REST ' . $point, 350)) {
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_RESTART_BAD_RESPONSE', $this->_response, $point));
            return false;
        }
    ...
    public function create($path) {
        ...
        if (FTP_NATIVE) {
            ...
            if (@ftp_pasv($this->_conn, true) === false) {
                MError::raiseWarning('36', MText::_('MLIB_CLIENT_ERROR_MFTP_CREATE_BAD_RESPONSE_PASSIVE'));
                return false;
            }

            $buffer = fopen('buffer://tmp', 'r');
            if (@ftp_fput($this->_conn, $path, $buffer, FTP_ASCII) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_CREATE_BAD_RESPONSE_BUFFER'));
                fclose($buffer);
                return false;
            }
            fclose($buffer);
        ...
        if (!$this->_putCmd('STOR ' . $path, array(150, 125))) {
            ...
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_CREATE_BAD_RESPONSE', $this->_response, $path));
            return false;
        }
        ...
        if (!$this->_verifyResponse(226)) {
            MError::raiseWarning('37', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_CREATE_BAD_RESPONSE_TRANSFER', $this->_response, $path));
            return false;
        }
    ...
    public function read($remote, &$buffer) {
        ...
        if (FTP_NATIVE) {
            // Turn passive mode on
            if (@ftp_pasv($this->_conn, true) === false) {
                MError::raiseWarning('36', MText::_('MLIB_CLIENT_ERROR_MFTP_READ_BAD_RESPONSE_PASSIVE'));
                return false;
            }
            ...
            if (@ftp_fget($this->_conn, $tmp, $remote, $mode) === false) {
                fclose($tmp);
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_READ_BAD_RESPONSE_BUFFER'));
                return false;
            }
        ...
        if (!$this->_putCmd('RETR ' . $remote, array(150, 125))) {
            @ fclose($this->_dataconn);
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_READ_BAD_RESPONSE', $this->_response, $remote));
            return false;
        }
        ...
        if (!$this->_verifyResponse(226)) {
            MError::raiseWarning('37', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_READ_BAD_RESPONSE_TRANSFER', $this->_response, $remote));
            return false;
        }
    ...
    public function get($local, $remote) {
        ...
        if (FTP_NATIVE) {
            // Turn passive mode on
            if (@ftp_pasv($this->_conn, true) === false) {
                MError::raiseWarning('36', MText::_('MLIB_CLIENT_ERROR_MFTP_GET_PASSIVE'));
                return false;
            }

            if (@ftp_get($this->_conn, $local, $remote, $mode) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_GET_BAD_RESPONSE'));
                return false;
            }
            return true;
        }
        ...
        $fp = fopen($local, "wb");
        if (!$fp) {
            MError::raiseWarning('38', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_GET_WRITING_LOCAL', $local));
            return false;
        }
        ...
        if (!$this->_putCmd('RETR ' . $remote, array(150, 125))) {
            @ fclose($this->_dataconn);
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_GET_BAD_RESPONSE_RETR', $this->_response, $remote));
            return false;
        }
        ...
        if (!$this->_verifyResponse(226)) {
            MError::raiseWarning('37', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_GET_BAD_RESPONSE_TRANSFER', $this->_response, $remote));
            return false;
        }
    ...
    public function store($local, $remote = null) {
        ...
        if (FTP_NATIVE) {
            // Turn passive mode on
            if (@ftp_pasv($this->_conn, true) === false) {
                MError::raiseWarning('36', MText::_('MLIB_CLIENT_ERROR_MFTP_STORE_PASSIVE'));
                return false;
            }

            if (@ftp_put($this->_conn, $remote, $local, $mode) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_STORE_BAD_RESPONSE'));
                return false;
            }
            return true;
        }
        ...
        if (@ file_exists($local)) {
            $fp = fopen($local, "rb");
            if (!$fp) {
                MError::raiseWarning('38', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_STORE_READING_LOCAL', $local));
                return false;
            }
        }
        else {
            MError::raiseWarning('38', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_STORE_FIND_LOCAL', $local));
            return false;
        }
        ...
        if (!$this->_putCmd('STOR ' . $remote, array(150, 125))) {
            @ fclose($fp);
            @ fclose($this->_dataconn);
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_STORE_BAD_RESPONSE_STOR', $this->_response, $remote));
            return false;
        }
        ...
        while (!feof($fp)) {
            ...
            do {
                if (($result = @ fwrite($this->_dataconn, $line)) === false) {
                    MError::raiseWarning('37', MText::_('MLIB_CLIENT_ERROR_MFTP_STORE_DATA_PORT'));
                    return false;
                }
        ...
        if (!$this->_verifyResponse(226)) {
            MError::raiseWarning('37', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_STORE_BAD_RESPONSE_TRANSFER', $this->_response, $remote));
            return false;
        }
    ...
    public function write($remote, $buffer) {
        ...
        if (FTP_NATIVE) {
            // Turn passive mode on
            if (@ftp_pasv($this->_conn, true) === false) {
                MError::raiseWarning('36', MText::_('MLIB_CLIENT_ERROR_MFTP_WRITE_PASSIVE'));
                return false;
            }
            ...
            if (@ftp_fput($this->_conn, $remote, $tmp, $mode) === false) {
                fclose($tmp);
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_WRITE_BAD_RESPONSE'));
                return false;
            }
            fclose($tmp);
            return true;
        ...
        // Send store command to the FTP server
        if (!$this->_putCmd('STOR ' . $remote, array(150, 125))) {
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_WRITE_BAD_RESPONSE_STOR', $this->_response, $remote));
            @ fclose($this->_dataconn);
            return false;
        }
        ...
        do {
            if (($result = @ fwrite($this->_dataconn, $buffer)) === false) {
                MError::raiseWarning('37', MText::_('MLIB_CLIENT_ERROR_MFTP_WRITE_DATA_PORT'));
                return false;
            }
        ...
        if (!$this->_verifyResponse(226)) {
            MError::raiseWarning('37', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_WRITE_BAD_RESPONSE_TRANSFER', $this->_response, $remote));
            return false;
        }
    ...
    public function listNames($path = null) {
        ...
        if (FTP_NATIVE) {
            // Turn passive mode on
            if (@ftp_pasv($this->_conn, true) === false) {
                MError::raiseWarning('36', MText::_('MLIB_CLIENT_ERROR_MFTP_LISTNAMES_PASSIVE'));
                return false;
            }
            ...
            if (($list = @ftp_nlist($this->_conn, $path)) === false) {
                ...
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_LISTNAMES_BAD_RESPONSE'));
                return false;
            }
        ...
        if (!$this->_putCmd('NLST' . $path, array(150, 125))) {
            ...
            MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_LISTNAMES_BAD_RESPONSE_NLST', $this->_response, $path));
            return false;
        }
        ...
        // Everything go okay?
        if (!$this->_verifyResponse(226)) {
            MError::raiseWarning('37', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_LISTNAMES_BAD_RESPONSE_TRANSFER', $this->_response, $path));
            return false;
        }
    ...
    public function listDetails($path = null, $type = 'all') {
        ...
        if (FTP_NATIVE) {
            // Turn passive mode on
            if (@ftp_pasv($this->_conn, true) === false) {
                MError::raiseWarning('36', MText::_('MLIB_CLIENT_ERROR_MFTP_LISTDETAILS_PASSIVE'));
                return false;
            }

            if (($contents = @ftp_rawlist($this->_conn, $path)) === false) {
                MError::raiseWarning('35', MText::_('MLIB_CLIENT_ERROR_MFTP_LISTDETAILS_BAD_RESPONSE'));
                return false;
            }
        }
        else {
            ...
            if (!$this->_putCmd(($recurse == true) ? 'LIST -R' : 'LIST' . $path, array(150, 125))) {
                MError::raiseWarning('35', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_LISTDETAILS_BAD_RESPONSE_LIST', $this->_response, $path));
                @ fclose($this->_dataconn);
                return false;
            }
            ...
            // Everything go okay?
            if (!$this->_verifyResponse(226)) {
                MError::raiseWarning('37', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_LISTDETAILS_BAD_RESPONSE_TRANSFER', $this->_response, $path));
                return false;
            }
        ...
        if (!$osType) {
            MError::raiseWarning('SOME_ERROR_CODE', MText::_('MLIB_CLIENT_ERROR_MFTP_LISTDETAILS_UNRECOGNISED'));
            return false;
        }
    ...
    protected function _putCmd($cmd, $expectedResponse) {
        ...
        if (!is_resource($this->_conn)) {
            MError::raiseWarning('31', MText::_('MLIB_CLIENT_ERROR_MFTP_PUTCMD_UNCONNECTED'));
            return false;
        }

        // Send the command to the server
        if (!fwrite($this->_conn, $cmd . "\r\n")) {
            MError::raiseWarning('32', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_PUTCMD_SEND', $cmd));
        }
    ...
    protected function _verifyResponse($expected) {
        ...
        if (!isset($parts[1])) {
            MError::raiseWarning('SOME_ERROR_CODE', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_VERIFYRESPONSE', $this->_response));
            return false;
        }
    ...
    protected function _passive() {
        ...
        // Make sure we have a connection to the server
        if (!is_resource($this->_conn)) {
            MError::raiseWarning('31', MText::_('MLIB_CLIENT_ERROR_MFTP_PASSIVE_CONNECT_PORT'));
            return false;
        }
        ...
        // Catch a timeout or bad response
        if (!isset($parts[1])) {
            MError::raiseWarning('SOME_ERROR_CODE', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_PASSIVE_RESPONSE', $this->_response));
            return false;
        }
        ...
        if ($this->_responseCode != '227') {
            MError::raiseWarning('36', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_PASSIVE_IP_OBTAIN', $this->_responseMsg));
            return false;
        }

        // Snatch the IP and port information, or die horribly trying...
        if (preg_match('~\((\d+),\s*(\d+),\s*(\d+),\s*(\d+),\s*(\d+)(?:,\s*(\d+))\)~', $this->_responseMsg, $match) == 0) {
            MError::raiseWarning('36', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_PASSIVE_IP_VALID', $this->_responseMsg));
            return false;
        }
        ...
        if (!$this->_dataconn) {
            MError::raiseWarning('30', MText::sprintf('MLIB_CLIENT_ERROR_MFTP_PASSIVE_CONNECT', $this->_pasv['ip'], $this->_pasv['port'], $errno, $err));
            return false;
        }
